...
class EvssaFunciones {
	...
	public static function concecutivo ($tabla)
	{
		...
		return EvssaFunciones :: objetoVacio ( 
		EvssaFunciones :: ultimoRegistro ( $tabla ) ) ? EvssaConstantes :: IDINICIAL : EvssaFunciones :: cerosIzquierda ( 
		EvssaFunciones :: convertirIdEntero ( 
		EvssaFunciones :: ultimoRegistro ( $tabla ) -> id ) + 1 );
